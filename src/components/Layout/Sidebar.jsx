        ...
        <>
            ...
            `}>
                ...
                <nav className="flex-1 px-4 py-6 space-y-2 overflow-y-auto">
                    ...
                    <NavItem icon={Sprout} label="Sustainability" active={activeView === 'sustainability'} onClick={() => { onNavigate('sustainability'); onClose?.(); }} />
                    <NavItem icon={Trash2} label="Waste Management" active={activeView === 'waste-management'} onClick={() => { onNavigate('waste-management'); onClose?.(); }} />
